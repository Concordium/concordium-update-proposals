...
- :ref:`CIS-8004-functions-supports`
...
A contract implementing this standard MUST also export the complete :ref:`CIS-2<CIS-2>` interface
(``transfer``, ``balanceOf``, ``operatorOf``, ``updateOperator``, ``tokenMetadata``).

.. _CIS-8004-functions-supports:
